...
import { LayoutDashboard, Calendar, CheckSquare, Activity, LogOut, Code, FolderGit2, Moon, Sun, GraduationCap, User, Settings } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ 
  ...
  const allNavItems = [
    ...
    { id: 'tracker', label: 'Tracker', icon: Calendar }, // Shortened label for mobile
        ...
        <div className="p-8 pb-6">
          <div className="flex items-center gap-3 text-accent-primary">
             ...
             <div className="flex flex-col">
                <span className="text-xl font-bold leading-none tracking-tight">Semester</span>
                <span className="text-xl font-bold leading-none tracking-tight">Growth</span>
             </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <header className="bg-bg-secondary border-b border-border p-4 pt-safe flex justify-between items-center z-10 transition-colors duration-300 shadow-sm">
           <div className="flex items-center gap-2 md:hidden">
             ...
             <h1 className="text-lg font-bold text-accent-primary">Semester Growth</h1>
           </div>
           
           {/* Date Display (Desktop only mostly, but good for header) */}
        ...
        {/* Main Content Area */}
        {/* Added specific bottom padding calculation for mobile to clear fixed navigation */}
